...
import { TaskCategoryText, ToDoListState } from './types';
...
export const EditTask = ({
  ...
  const [taskDescriptionInput, setTaskDescriptionInput] =
    useState(taskDescription);
  const [taskCategoryInput, setTaskCategoryInput] = useState(categoryText);
